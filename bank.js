...
function Transfer() 
{
var myaccount=parseInt(document.getElementById('AkshayBalance').innerText);
...
let myaccount=parseInt(document.getElementById('AkshayBalance').innerText)-transfer_Amount;
...
document.getElementById('AkshayBalance').innerText=myaccount;
alert("Continue")
document.getElementById('AkshayBalance').innerText=myaccount;
